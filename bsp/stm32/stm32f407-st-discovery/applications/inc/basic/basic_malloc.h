#ifndef _BASIC_MALLOC_H_
#define _BASIC_MALLOC_H_
...
#define MEM_MAX_SIZE		    16*1024  						      //总的最大管理内存大小 16K
#define MEM_ALLOC_TABLE_SIZE	MEM_MAX_SIZE/MEM_BLOCK_SIZE           //内存表：内存块的个数
